...
public class QuertUtils {
    ...
    public static final String LOG_TAG = QuertUtils.class.getSimpleName();

    public QuertUtils() {
    }

    private static List<earthquakeData> extractEarthquakes(String earthquakeJSON){

        Log.i(LOG_TAG, "extractEarthquakes() method is called....");
